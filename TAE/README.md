...
## 주요 파일
- `models/`: 모델 아키텍처 및 다양한 손실 함수 (COAST loss 포함)
...
## 핵심 기능 (COAST Loss)
기존의 MSE 기반 위상 손실 함수 대신 **COAST (Cosine Optimized Adaptive Sinkhorn Transport)** 로스를 추가했습니다.
...
- **Topo Multiplier**: COAST loss의 Sinkhorn divergence는 MSE에 비해 값이 매우 작습니다. 보통 `10^2` ~ `10^4` 정도의 multiplier를 주어야 학습이 제대로 일어납니다.
